...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/claim.css" />
        ...
        <div class="main-right">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active" aria-current="page">請求確認</li>
            </ol>
          </nav>
          <div id="info">
            <!-- 画像 -->
          ...
          <div class="yoyaku">
            ...
            <!-- 予約情報 -->
            <h3>予約時間</h3>
            <p><?php echo $date ?>　<?php echo $time[0] ?> ~ <?php echo $time[1] ?></p>
            <h3>合計金額</h3>
            <p><?php echo $sales[0]['sales_amount'] ?>円</p>
          </div>
          <div class="link">
            <form class="" action="productbuy.php" method="post">
