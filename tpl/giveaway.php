...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/giveaway.css">
    ...
    <main>
      <div class="main-content flex j-a">
        ...
        <div class="main-right">
          <article>
            <h2 class="none">景品選択画面</h2>
            <p class="main-title">「景品を選択してください」</p>
            <?php if (@$_SESSION['giveaway_flg']) :
                            echo $_SESSION['giveaway_flg'];
                            unset($_SESSION['giveaway_flg']);
                        endif; ?>
            <!--  -->
            <section>
              <img src='./img/IH_img/' alt=''>
              <div class="top-card-lists">
                <?php foreach($lists as $list): ?>
                <div class="top-card">
                  <a href="./giveawayfixed.php?id=<?php echo $list["award_id"];?>">
                    <img src="./img/IH_img/giveaway<?php echo $list["award_id"];?>.jpg" alt="景品画像" />
                  </a>
                  <dl class="top-card-lists-main">
                    <dt><?php echo $list[0];?></dt>
                    <div class="flex j-b top-card-lists-dd">
                      <dt><?php echo $list[1];?></dt>
                    </div>
                  </dl>
                </div>
                <?php endforeach; ?>
