...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/settlementcomplete.css">
</head>
            ...
            <section>
              ...
              <table class="table table-bordered">
                ...
                <tr>
                  <th>決済内容</th>
                  <td>予約時間<br>
                    <?php echo $date ?>　<?php echo $time[0] ?> ~ <?php echo $time[1] ?><br>
                  </td>
                </tr>
                <tr>
                  <th>決済金額</th>
                  <td>￥<?php echo $sales[0]['sales_amount'] ?></td>
                </tr>
              </table>
              <p class="text-right"><a href="producttrading.php">商品取引画面へ→</a></p>
            </section>
          </article>
        </div>
      </div>
