...
<head>
  ...
  <link rel="stylesheet" href="src/css/pages/payment.css" />
        ...
        <div class="main-right">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="reservation.php">時間指定</a></li>
              <li class="breadcrumb-item"><a href="reservation.php">確認</a></li>
              <li class="breadcrumb-item"><a href="reservation.php">請求内容確認</a></li>
              <li class="breadcrumb-item active" aria-current="page">決済</li>
            </ol>
          </nav>
          <div class="payment">
            <h1>決済方法の選択</h1>
            <div class="payimg">
              <img src="src/img/main/payment.png" alt="" width="60%">
            </div>
            <div class="paymenu">
              <!-- 決済選択一覧 -->
              <button type="button" name="button"><img src="src/img/main/visa.png" alt=""></button>
              <button type="button" name="button"><img src="src/img/main/master.png" alt=""></button>
              <button type="button" name="button"><img src="src/img/main/jcb.jfif" alt=""></button>
            </div>
          </div>
          <div class="cardinfo">
            <!-- カード情報 -->
            <form class="" action="#" method="post">
              <p>カード番号</p>
              <input class="number" type="text" name="" value=""><br><br>
              <div class="credit">
                <div class="time_limit">
                  ...
                  <p>
                    <select name="month">
                      <?php for ($i = 0; $i < 12; $i++) { ?>
                      <?php $select_month = $i + 1; ?>
                      <option value="<?php echo $select_month ?>"><?php echo $select_month; ?>
                      </option>
                      <?php  } ?>
                    </select>月
                    <select name="year">
                      <?php for ($i = 0; $i < 11; $i++) { ?> <option value="<?php echo $year_date; ?>">
                        <?php echo $year_date; ?></option>
                      <?php $year_date++; ?>
                      <?php  } ?>
                    </select>年
                  </p>
              ...
              <p><input type="checkbox" name="" value="">このカード情報を保存して、次回も使用する</p>
            </form>
            <form action="claim.php" method="post">
              <div class="button">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input type="hidden" name="sales_code" value="<?php echo $sales_code; ?>">
                <input id="sub1" class="btn btn-success" type="submit" name="" value="ひとつ前に戻る">
              </div>
            </form>
            <br>
            <form action="settlementcomplete.php" method="post">
              <div class="button">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <input type="hidden" name="sales_code" value="<?php echo $sales_code; ?>">
                <input id="sub2" class="btn btn-success" type="submit" name="" value="次の画面に進む">
              </div>
            </form>
          </div>
        </div>
