...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/salesconfirmation.css">
</head>
            ...
            <section>
              ...
              <div class="clearinginfo">
                <table class="table table-bordered">
                  <thead>
                    <tr class="d-flex">
                      <th class="col-2">1月</th>
                      <td class="col-4">￥<?php echo $january;?></td>
                      <th class="col-2">2月</th>
                      <td class="col-4">￥<?php echo $february;?></td>
                    </tr>
                    <tr class="d-flex">
                      <th class="col-2">3月</th>
                      <td class="col-4">￥<?php echo $march;?></td>
                      <th class="col-2">4月</th>
                      <td class="col-4">￥<?php echo $april;?></td>
                    </tr>
                    <tr class="d-flex">
                      <th class="col-2">5月</th>
                      <td class="col-4">￥<?php echo $may;?></td>
                      <th class="col-2">6月</th>
                      <td class="col-4">￥<?php echo $june;?></td>
                    </tr>
                    <tr class="d-flex">
                      <th class="col-2">7月</th>
                      <td class="col-4">￥<?php echo $july;?></td>
                      <th class="col-2">8月</th>
                      <td class="col-4">￥<?php echo $augst;?></td>
                    </tr>
                    <tr class="d-flex">
                      <th class="col-2">9月</th>
                      <td class="col-4">￥<?php echo $september;?></td>
                      <th class="col-2">10月</th>
                      <td class="col-4">￥<?php echo $october;?></td>
                    </tr>
                    <tr class="d-flex">
                      <th class="col-2">11月</th>
                      <td class="col-4">￥<?php echo $november;?></td>
                      <th class="col-2">12月</th>
                      <td class="col-4">￥<?php echo $december;?></td>
                    </tr>
                  </thead>
                </table>
              </div>
              <h3>合計金額</h3>
              <div class="clearinginfo-total">
                <dl>
                  <dt>2020年度決算合計</dt>
                  <dd>￥<?php echo $year_price;?></dd>
                </dl>
              </div>
