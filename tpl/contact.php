        ...
        <div class="main-right">
          ...
          <div class="contact-form">
            <form action="./contact.php" method="POST">
              <p>お名前<br>
                <input type="text" name="name" style="width: 500px;" size="">
              </p>
              <p>メールアドレス<br>
                <input type="text" name="mail" style="width: 500px;" size="">
              </p>
              <p>お問い合わせ内容<br>
                <textarea rows="10" cols="80" name="contact"></textarea>
              </p>
              <p>
                <input type="submit" class="contact-button" value="送信">
              </p>
            </form>
          </div>
          <div class="contact-ans">
            <table class="contact-table" width="900px" border="1">
              <tr>
                <th class="contact-q" height="100px">Q</th>
                <td class="contact-QA">どこの学校に通っていますか？</td>
              </tr>
              <tr>
                <th class="contact-a" height="120px">A</th>
                <td class="contact-QA">HAL大阪</td>
              </tr>
            </table><br>
            <table class="contact-table" width="900px" border="1">
              <tr>
                <th class="contact-q" height="100px">Q</th>
                <td class="contact-QA">何学部ですか？</td>
              </tr>
              <tr>
                <th class="contact-a" height="120px">A</th>
                <td class="contact-QA">IT学部</td>
              </tr>
            </table>
          </div>
        </div>
