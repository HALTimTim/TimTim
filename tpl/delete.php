...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/delete.css" />
              ...
              <div class="posted-main-bottom">
                ...
                <div class="posted-main-bottom-right">
                  ...
                  <div class="posted-main-bottom-right-img">
                    ...
                    <div>
                      <p>画像を削除します?</p>
                      <form action="" method="post" class="posted-main-bottom-right-form">
                        <input type="submit" value="キャンセル" name="cancelbutton" />
                        <input type="submit" value="削除" name="deletebutton" />
                      </form>
                    </div>
                    <div>
                      <p>評価</p>
                      <button>👍<span>120</span></button>
                      <button>👎<span>32</span></button>
                      <p>コメント一覧</p>
                      <p>
                        今日はコーディナイトをしてもらって凄い楽しかったです。
                      </p>
                    </div>
                  </div>
