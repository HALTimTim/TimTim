...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/giveawayfixed.css">
    ...
    <main>
      <div class="main-content flex j-a">
        ...
        <div class="main-right">
          <article>
            <h2 class="none">景品選択確定画面</h2>
            <p class="main-title">「景品を選択してください」</p>
            <?php
                        if (@$_SESSION['award_result']) :
                            echo $_SESSION['award_result'];
                            unset($_SESSION['award_result']);
                        endif; ?>
            <section>
              <div class="top-card-lists">
                <div class="top-card">
                  <a href="">
                    <img src="./img/IH_img/giveaway<?php echo $_GET["id"]; ?>.jpg" alt="" />
                  </a>
                ...
                <div>
                  <p>商品を確定しますか？</p>
                  <form action="" method="post">
                    <input type="submit" value="確定する" name="fixedbtn" />
