          ...
          <article>
            ...
            <section>
              ...
              <div class="top-card-lists">
                ...
                <div class="top-card">
                  <a href="">
                    <img src="./src/img/POST_img/<?php echo $list["post_img"]; ?>.png" alt="" />
                  </a>
                  <dl class="top-card-lists-main">
                    <dt><?php echo $list["LastName"].$list["FirstName"]; ?></dt>
                  </dl>
                </div>
                <?php endforeach; ?>
              </div>
            ...
            <section>
              <div class="top-card-lists">
                <h3>カジュアルランキング</h3>
                <form action='' method='post'>
                  <button type="submit" class="btn btn-info" name="C1" value="C1">もっと見る</button>
                </form>
              </div>
              <div class="top-card-lists">
                <?php foreach($k_lists as $list):?>
                <div class="top-card">
                  <a href="">
                    <img src="./src/img/POST_img/<?php echo $list["post_img"]; ?>.png" alt="" />
                  </a>
            ...
            <section>
              <div class="top-card-lists">
                <h3>ストリート系ランキング</h3>
                <form action='' method='post'>
                  <button type="submit" class="btn btn-info" name="C11" value="C11">もっと見る</button>
                </form>
              </div>
              <div class="top-card-lists">
                <?php foreach($s_lists as $list):?>
                <div class="top-card">
                  <a href="">
                    <img src="./src/img/POST_img/<?php echo $list["post_img"]; ?>.png" alt="" />
                  </a>
            ...
            <section>
              <div class="top-card-lists">
                <h3>渋谷系ランキング</h3>
                <form action='' method='post'>
                  <button type="submit" class="btn btn-info" name="C12" value="C12">もっと見る</button>
                </form>

              </div>
              <div class="top-card-lists">
                <?php foreach($c_lists as $list):?>
                <div class="top-card">
                  <a href="">
                    <img src="./src/img/POST_img/<?php echo $list["post_img"]; ?>.png" alt="" />
                  </a>
