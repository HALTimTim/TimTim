                ...
                <ul>
                  <li>
                    <div class="helpDropdown">
                      <label for="menu1">
                        <h3>ログイン方法を忘れた・わからない</h3>
                      </label>
                      <input type="checkbox" id="menu1">
                      <ul class="dropdown1">
                        <div class="login">
                          <li>
                            <p>ログイン方法を忘れてしまった場合下記をお試しください。</p>
                            <p>
                              1)サイトからのメールを受け取ったことがある方<br>
                              └サイトからメールを受け取っているメールアドレスでのログイン方法をお試しください。<br>
                            </p>
                            <p>
                              上記、1) に当てはまらないその他ログイン方法でもログインできない場合<br>
                              大変お手数ではございますが新規会員登録ページより新たに会員登録にお進みこのサイトをご利用いただきますようお願い申し上げます。<br>
                            </p>
                          </li>
                        </div>
                      </ul>
                  ...
                  <li>
                    <div class="helpDropdown">
                      ...
                      <ul class="dropdown2">
                        <div class="login">
                          <li>
                            <p>ログインできない場合、入力いただいたメールアドレス・パスワードに誤りがないか今一度ご確認ください。</p>
                            <p> それでもログインできない場合は、お手数ですがパスワードの再設定を行なってください。
                            </p>
                            <p>また、複数メールアドレスをお持ちのお客様は他メールアドレスでの会員登録ではないか、ご確認をお願いいたします。</p>
                          </li>
                        </div>
                      </ul>
                    </div>
                  ...
                  <li>
                    <div class="helpDropdown">
                      ...
                      <ul class="dropdown3">
                        <div class="login">
                          <li>
                            <p>マイページはお客様専用にご用意している会員情報ページです。</p>
                            ...
                            <h4>マイページへのログインは、ログインページで会員登録したメールアドレス、パスワードにてログインください。</h4>
                          </li>
                        </div>
                      </ul>
                    </div>
                    ...
                    <div class="helpDropdown">
                      ...
                      <ul class="dropdown4">
                        <div class="login">
                          <li>
                            <p>新規登録ありがとうございます。<br>
                              当サイトは服装を悩んでしまう人とおしゃれな人をつなぐサービスです。<br>
                              このサイトを通じてファッションに興味を持っていただけたら嬉しいです。</p>
                          </li>
                        </div>
                      </ul>
                    </div>
