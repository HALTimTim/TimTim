...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/edit.css">
            ...
            <section>
              <div class="posted-main-top">
                <div class="posted-main-top-left">
                  <img src="./src/img/main/<?php echo $purofile_img; ?>.png" name="icon" width="100" alt="アイコン画像" />
                </div>
                <!-- 右上エリア -->
                ...
                <div class="posted-main-bottom-right">
                  ...
                  <div class="posted-main-bottom-right-img">
                    <?php if (isset($post_choise_id)) : ?>
                      <img src="./src/img/POST_img/<?php echo $choise_img; ?>.png" alt="プロフ画像" />
                      <p><?php echo $choise_caption; ?></p>
                    <?php endif; ?>
                    <div>
                      <p>投稿を変更する</p>
                      <form action="./edit.php" method="post" enctype="multipart/form-data">
                        <input type="file" name="upload_file" accept=".png, .jpg">
                        <div class="post-img" id="flex">
                          <textarea rows="5" cols="40" name="user_text"></textarea>
                        </div>
                        <button type="reset">キャンセル</button>
                        <button type="submit" name="id" value="<?php echo @$post_choise_id; ?>">変更</button>
                      </form>
                    </div>
                  </div>
                  <div class="posted-main-bottom-right-img-list">
                    <?php foreach ($post_result as $value) : ?>
                      <p>
                        ...
                        <a href="edit.php?id=<?php echo $value['post_id']; ?>">
