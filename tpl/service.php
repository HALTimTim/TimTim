    ...
    <main>
      <div class="main-content flex j-a">
        ...
        <div class="main-right">
          <div class="service-title1" id="flex">
            <img src="./src/img/service/service1.png" width="40px">
            <h1>ご利用ガイド</h1>
          </div>
          <p class="service-text1">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
          <div class="service-title2" id="flex">
            <img src="./src/img/service/service2.png" width="50px">
            <h2>サービスを出品したい</h2>
          </div>
          <p class="service-text2">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
          <div class="service-left">
            <div class="service-title3" id="flex">
              <img src="./src/img/service/service3.png" width="50px">
              <h2>サービスを購入したい</h2>
            </div>
            <p class="service-text2">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
          </div>
          <div class="service-title2" id="flex">
            <img src="./src/img/service/service4.png" width="50px">
            <h2>お支払方法・手数料</h2>
          </div>
          <p class="service-text2">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
          ...
          <div class="service-left">
            <div class="service-title3" id="flex">
              <img src="./src/img/service/service5.png" width="50px">
              <h2>取引の流れ</h2>
            </div>
            <p class="service-text2">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
          </div>
          ...
          <div class="service-title2" id="flex">
            <img src="./src/img/service/service6.png" width="50px">
            <h2>評価について</h2>
          </div>
          <p class="service-text2">この文章はダミーです。<br>文字の大きさ、量、字間、行間等を確認するために入れています。</p>
