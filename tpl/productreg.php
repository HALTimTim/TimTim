...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/productreg.css">
</head>
    ...
    <main>
      <div class="main-content flex j-a">
        ...
        <div class="main-right">
          <h1 class="productreg-title">時間登録入力画面</h1>
          <ul class="productreg-list">
            <li><a href="#">今日 (日付)</a> |</li>
            <li><a href="#">明日 (日付)</a> |</li>
            <li><a href="#">土曜日 (日付)</a> |</li>
            <li><a href="#">日曜日 (日付)</a> |</li>
            <li><a href="#">カレンダー指定</a></li>
          </ul>
          <div class="productreg-day" id="flex">
            <?php for ($a = 1; $a <= 2; $a++) : ?>
            <select name="" id="">
              <?php for ($i = 1; $i <= 24; $i++) : ?>
            ...
            時
            <select name="" id="">
              <option value="minutetu1">0</option>
              <option value="minutetu2">30</option>
            </select>
            分
            <?php if($a == 1):?>
            <?php echo "～";?>
          ...
          <div class="productreg-text" id="flex">
            <p>金額入力欄</p>
            <input type="text" name="" style="width: 150px; height: 30px;">
          </div>
          <form action="" method="post">
