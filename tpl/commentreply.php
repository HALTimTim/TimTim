...
<head>
  ...
  <link rel="stylesheet" href="./src/css/pages/commentreply.css">
            ...
            <section>
              <div class="posted-main-top">
                <div class="posted-main-top-left">
                  <img src="./src/img/main/icon.png" name="icon" width="100" alt="アイコン画像" />
                  <p>最終ログイン:3時間前</p>
                  <p>稼働状況対応：可能</p>
                </div>
                <!-- 右上エリア -->
                <div class="posted-main-top-right">
                  <!-- 左側 -->
                  <div>
                    <p name="username">鈴木太郎</p>
                    <p class="role">
                      クリエーター・デザイナー
                      <span class="role height">188cm</span>
                      <span class="role age">30代後半</span>
                      <span class="role gender">男性</span>
                    </p>
                    <p class="role">一言:</p>
                  </div>
                  <!-- 右側(ボタン) -->
                ...
                <div class="posted-main-bottom-right">
                  <div class="posted-main-bottom-right-state">
                    <div class="stats-right">
                      <ul>
                        <li>販売実績<span>1257</span></li>
                        <li>評価<span>5.0</span></li>
                        <li>フォロワー<span>515</span></li>
                      </ul>
                    </div>
                  </div>
                  <!-- 画像エリア -->
                  <div class="posted-main-bottom-right-img">
                    <img src="./src/img/main/icon.png" alt="プロフ画像" />
                    <div>
                      <form action="#">
                        <p>コメント</p>
                        <p>
                        ...
                        <p>返信</p>
                        <p>ありがとうございます<br /></p>
                        <input type="button" value="削除" name="deletingbutton" />
                        <input type="button" value="送信" name="sendingbutton" />
                      </form>
                    </div>
                  </div>
                  <div>
                    <p>チャームポイントは:<span>防止です</span></p>
                    <ul>
                      <li>#帽子が素敵</li>
                      <li>#帽子が素敵</li>
                      <li>#帽子が素敵</li>
                  ...
                  <div class="posted-main-bottom-right-img-list">
                    <div class="posted-main-bottom-right-img-list-card">
                      <img src="./src/img/main/icon.png" alt="プロフ画像" />
                      <img src="./src/img/main/icon.png" alt="プロフ画像" />
                      <img src="./src/img/main/icon.png" alt="プロフ画像" />
                      <img src="./src/img/main/icon.png" alt="プロフ画像" />
